...
export default function NotFound() {
	return (
		<section className='flex items-center h-full sm:p-16 bg-gray-900 text-gray-200'>
			<div className='container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center sm:max-w-md'>
				...
				<p className='text-3xl mb-0'>Oops..</p>
				<p className='text-2xl'>Lo sentimos, esta página no está disponible.</p>
				<Link
					href='/'
					rel='noopener noreferrer'
					className='px-8 py-3 font-semibold rounded bg-blue-600 hover:bg-blue-700 text-gray-50 border'>
					Volver
				</Link>
			</div>
		</section>
